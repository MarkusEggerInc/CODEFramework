...
namespace CODE.Framework.Wpf.Controls
{
    ...
    public class PasswordBoxEx : Control
    {
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.RegisterAttached("Value", typeof (string), typeof (PasswordBoxEx), new FrameworkPropertyMetadata("", ValuePropertyChanged) {BindsTwoWayByDefault = true, DefaultUpdateSourceTrigger = UpdateSourceTrigger.LostFocus});
