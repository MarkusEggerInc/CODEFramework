...
using CODE.Framework.Wpf.Theme.Battleship.Standard;

namespace CODE.Framework.Wpf.Theme.Battleship.Classes
{
    /// <summary>
    /// Standard features supported by the Battleship theme
    /// </summary>
    public class BattleshipStandardFeatures : IThemeStandardFeatures
    {
        ...
        private readonly IStandardViewFactory _standardViewFactory = new BattleshipStandardViewFactory();
    }

    /// <summary>Factory to create standard views supported by Battleship</summary>
    public class BattleshipStandardViewFactory : IStandardViewFactory
    {
